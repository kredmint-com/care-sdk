...
class SdkRequest {
  ...
  factory SdkRequest.fromJson(Map<String, dynamic> json) =>
      SdkRequest(
  ...
  Map<String, dynamic> toJson() =>
      {
        ...
        "gender": gender,
        "email": email,
        "dob": (dob == null) || (dob.toString().isEmpty) ? null :
        "${dob!.year.toString().padLeft(4, '0')}-${dob!
            .month
            .toString()
            .padLeft(2, '0')}-${dob!.day.toString().padLeft(2, '0')}",
